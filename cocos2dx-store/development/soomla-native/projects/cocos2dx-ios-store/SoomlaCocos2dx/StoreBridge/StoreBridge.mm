...
+ (void)initGlue {
    ...
    [ndkGlue registerCallHandlerForKey:@"CCStoreEventDispatcher::pushOnItemPurchased" withBlock:^(NSDictionary *parameters, NSMutableDictionary *retParameters) {
        NSDictionary *userInfo = @{ DICT_ELEMENT_ID_PURCHASABLE_ID: [parameters objectForKey:@"itemId"],
                                    DICT_ELEMENT_ID_DEVELOPERPAYLOAD: [parameters objectForKey:@"payload"] };

        [[NSNotificationCenter defaultCenter] postNotificationName:EVENT_ID_ITEM_PURCHASED object:[NdkGlue sharedInstance] userInfo:userInfo];
    }];
    ...
    [ndkGlue registerCallHandlerForKey:@"CCStoreEventDispatcher::pushOnItemPurchaseStarted" withBlock:^(NSDictionary *parameters, NSMutableDictionary *retParameters) {
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:EVENT_ID_ITEM_PURCHASE_STARTED object:[NdkGlue sharedInstance] userInfo:userInfo];
    }];
    ...
    [ndkGlue registerCallHandlerForKey:@"CCStoreEventDispatcher::pushOnUnexpectedStoreError" withBlock:^(NSDictionary *parameters, NSMutableDictionary *retParameters) {
        NSDictionary *userInfo = @{
                DICT_ELEMENT_ID_ERROR_CODE: parameters[@"errorCode"]
        };
        [[NSNotificationCenter defaultCenter] postNotificationName:EVENT_ID_UNEXPECTED_STORE_ERROR object:[NdkGlue sharedInstance] userInfo:userInfo];
    }];
    ...
    [ndkGlue registerCallHandlerForKey:@"CCStoreEventDispatcher::pushOnSoomlaStoreInitialized" withBlock:^(NSDictionary *parameters, NSMutableDictionary *retParameters) {
        [[NSNotificationCenter defaultCenter] postNotificationName:EVENT_ID_SOOMLASTORE_INIT object:[NdkGlue sharedInstance] userInfo:nil];
    }];
    ...
    /* -= Callback handlers =- */
    [ndkGlue registerCallbackHandlerForKey:EVENT_ID_BILLING_NOT_SUPPORTED withBlock:^(NSNotification *notification, NSMutableDictionary *parameters) {
        [parameters setObject:@"CCStoreEventHandler::onBillingNotSupported" forKey:@"method"];
    }];

    [ndkGlue registerCallbackHandlerForKey:EVENT_ID_BILLING_SUPPORTED withBlock:^(NSNotification *notification, NSMutableDictionary *parameters) {
        [parameters setObject:@"CCStoreEventHandler::onBillingSupported" forKey:@"method"];
    }];

    [ndkGlue registerCallbackHandlerForKey:EVENT_ID_CURRENCY_BALANCE_CHANGED withBlock:^(NSNotification *notification, NSMutableDictionary *parameters) {
        [parameters setObject:@"CCStoreEventHandler::onCurrencyBalanceChanged" forKey:@"method"];
        [parameters setObject:(NSString*)[notification.userInfo objectForKey:DICT_ELEMENT_ID_CURRENCY] forKey:@"itemId"];
        [parameters setObject:(NSNumber*)[notification.userInfo objectForKey:DICT_ELEMENT_ID_BALANCE] forKey:@"balance"];
        [parameters setObject:(NSNumber*)[notification.userInfo objectForKey:DICT_ELEMENT_ID_AMOUNT_ADDED] forKey:@"amountAdded"];
    }];

    [ndkGlue registerCallbackHandlerForKey:EVENT_ID_GOOD_BALANCE_CHANGED withBlock:^(NSNotification *notification, NSMutableDictionary *parameters) {
        [parameters setObject:@"CCStoreEventHandler::onGoodBalanceChanged" forKey:@"method"];
        [parameters setObject:(NSString*)[notification.userInfo objectForKey:DICT_ELEMENT_ID_GOOD] forKey:@"itemId"];
        [parameters setObject:(NSNumber*)[notification.userInfo objectForKey:DICT_ELEMENT_ID_BALANCE] forKey:@"balance"];
        [parameters setObject:(NSNumber*)[notification.userInfo objectForKey:DICT_ELEMENT_ID_AMOUNT_ADDED] forKey:@"amountAdded"];
    }];

    [ndkGlue registerCallbackHandlerForKey:EVENT_ID_GOOD_EQUIPPED withBlock:^(NSNotification *notification, NSMutableDictionary *parameters) {
        [parameters setObject:@"CCStoreEventHandler::onGoodEquipped" forKey:@"method"];
        [parameters setObject:(NSString*)[notification.userInfo objectForKey:DICT_ELEMENT_ID_EquippableVG] forKey:@"itemId"];
    }];

    [ndkGlue registerCallbackHandlerForKey:EVENT_ID_GOOD_UNEQUIPPED withBlock:^(NSNotification *notification, NSMutableDictionary *parameters) {
        [parameters setObject:@"CCStoreEventHandler::onGoodUnEquipped" forKey:@"method"];
        [parameters setObject:(NSString*)[notification.userInfo objectForKey:DICT_ELEMENT_ID_EquippableVG] forKey:@"itemId"];
    }];

    [ndkGlue registerCallbackHandlerForKey:EVENT_ID_GOOD_UPGRADE withBlock:^(NSNotification *notification, NSMutableDictionary *parameters) {
        [parameters setObject:@"CCStoreEventHandler::onGoodUpgrade" forKey:@"method"];
        [parameters setObject:(NSString*)[notification.userInfo objectForKey:DICT_ELEMENT_ID_GOOD] forKey:@"itemId"];
        [parameters setObject:(NSString*)[notification.userInfo objectForKey:DICT_ELEMENT_ID_UpgradeVG] forKey:@"vguItemId"];
    }];

    [ndkGlue registerCallbackHandlerForKey:EVENT_ID_ITEM_PURCHASED withBlock:^(NSNotification *notification, NSMutableDictionary *parameters) {
        NSString* payload = [notification.userInfo objectForKey:DICT_ELEMENT_ID_DEVELOPERPAYLOAD];
        [parameters setObject:@"CCStoreEventHandler::onItemPurchased" forKey:@"method"];
        [parameters setObject:(NSString*)[notification.userInfo objectForKey:DICT_ELEMENT_ID_PURCHASABLE_ID] forKey:@"itemId"];
        [parameters setObject:payload forKey:@"payload"];
    }];

    [ndkGlue registerCallbackHandlerForKey:EVENT_ID_ITEM_PURCHASE_STARTED withBlock:^(NSNotification *notification, NSMutableDictionary *parameters) {
        [parameters setObject:@"CCStoreEventHandler::onItemPurchaseStarted" forKey:@"method"];
        [parameters setObject:(NSString*)[notification.userInfo objectForKey:DICT_ELEMENT_ID_PURCHASABLE_ID] forKey:@"itemId"];
    }];

    [ndkGlue registerCallbackHandlerForKey:EVENT_ID_MARKET_PURCHASE_CANCELLED withBlock:^(NSNotification *notification, NSMutableDictionary *parameters) {
        PurchasableVirtualItem* pvi = (PurchasableVirtualItem*)[notification.userInfo objectForKey:DICT_ELEMENT_ID_PURCHASABLE];
    ...
    [ndkGlue registerCallbackHandlerForKey:EVENT_ID_MARKET_PURCHASE_DEFERRED withBlock:^(NSNotification *notification, NSMutableDictionary *parameters) {
        PurchasableVirtualItem* pvi = (PurchasableVirtualItem*)[notification.userInfo objectForKey:DICT_ELEMENT_ID_PURCHASABLE];
        NSString* payload = [notification.userInfo objectForKey:DICT_ELEMENT_ID_DEVELOPERPAYLOAD];
    ...
    [ndkGlue registerCallbackHandlerForKey:EVENT_ID_MARKET_PURCHASED withBlock:^(NSNotification *notification, NSMutableDictionary *parameters) {
        PurchasableVirtualItem* pvi = (PurchasableVirtualItem*) notification.userInfo[DICT_ELEMENT_ID_PURCHASABLE];
        NSString* payload = notification.userInfo[DICT_ELEMENT_ID_DEVELOPERPAYLOAD];
        NSString* extraInfo = notification.userInfo[DICT_ELEMENT_ID_EXTRA_INFO];
        NSNumber* isRestored = notification.userInfo[DICT_ELEMENT_ID_IS_RESTORED];

        parameters[@"method"] = @"CCStoreEventHandler::onMarketPurchase";
        parameters[@"itemId"] = [pvi itemId];
        parameters[@"payload"] = payload;
        parameters[@"extraInfo"] = extraInfo;
        parameters[@"isRestored"] = isRestored;
    }];

    [ndkGlue registerCallbackHandlerForKey:EVENT_ID_MARKET_PURCHASE_STARTED withBlock:^(NSNotification *notification, NSMutableDictionary *parameters) {
        PurchasableVirtualItem* pvi = (PurchasableVirtualItem*)[notification.userInfo objectForKey:DICT_ELEMENT_ID_PURCHASABLE];
        [parameters setObject:@"CCStoreEventHandler::onMarketPurchaseStarted" forKey:@"method"];
        [parameters setObject:[pvi itemId] forKey:@"itemId"];
    }];

    [ndkGlue registerCallbackHandlerForKey:EVENT_ID_MARKET_ITEMS_REFRESH_FINISHED withBlock:^(NSNotification *notification, NSMutableDictionary *parameters) {
        NSArray* marketItems = (NSArray*)[notification.userInfo objectForKey:DICT_ELEMENT_ID_MARKET_ITEMS];
    ...
    [ndkGlue registerCallbackHandlerForKey:EVENT_ID_MARKET_ITEMS_REFRESH_STARTED withBlock:^(NSNotification *notification, NSMutableDictionary *parameters) {
        [parameters setObject:@"CCStoreEventHandler::onMarketItemsRefreshStarted" forKey:@"method"];
    }];

    [ndkGlue registerCallbackHandlerForKey:EVENT_ID_MARKET_ITEMS_REFRESH_FAILED withBlock:^(NSNotification *notification, NSMutableDictionary *parameters) {
        [parameters setObject:@"CCStoreEventHandler::onMarketItemsRefreshFailed" forKey:@"method"];
        [parameters setObject:(NSString*)([notification.userInfo objectForKey:DICT_ELEMENT_ID_ERROR_MESSAGE] ?: @"") forKey:@"errorMessage"];
    }];

    [ndkGlue registerCallbackHandlerForKey:EVENT_ID_VERIFICATION_STARTED withBlock:^(NSNotification *notification, NSMutableDictionary *parameters) {
        PurchasableVirtualItem* pvi = (PurchasableVirtualItem*) notification.userInfo[DICT_ELEMENT_ID_PURCHASABLE];
        parameters[@"method"] = @"CCStoreEventHandler::onVerificationStarted";
        parameters[@"itemId"] = [pvi itemId];
    }];

    [ndkGlue registerCallbackHandlerForKey:EVENT_ID_MARKET_PURCHASE_VERIF withBlock:^(NSNotification *notification, NSMutableDictionary *parameters) {
        PurchasableVirtualItem* pvi = (PurchasableVirtualItem*)[notification.userInfo objectForKey:DICT_ELEMENT_ID_PURCHASABLE];
        [parameters setObject:@"CCStoreEventHandler::onMarketPurchaseVerification" forKey:@"method"];
        [parameters setObject:[pvi itemId] forKey:@"itemId"];
    }];

    [ndkGlue registerCallbackHandlerForKey:EVENT_ID_RESTORE_TRANSACTIONS_FINISHED withBlock:^(NSNotification *notification, NSMutableDictionary *parameters) {
        BOOL success = [(NSNumber*)[notification.userInfo objectForKey:DICT_ELEMENT_ID_SUCCESS] boolValue];
    ...
    [ndkGlue registerCallbackHandlerForKey:EVENT_ID_RESTORE_TRANSACTIONS_STARTED withBlock:^(NSNotification *notification, NSMutableDictionary *parameters) {
        [parameters setObject:@"CCStoreEventHandler::onRestoreTransactionsStarted" forKey:@"method"];
    }];

    [ndkGlue registerCallbackHandlerForKey:EVENT_ID_UNEXPECTED_STORE_ERROR withBlock:^(NSNotification *notification, NSMutableDictionary *parameters) {
        NSNumber* errorCode = notification.userInfo[DICT_ELEMENT_ID_ERROR_CODE];
        parameters[@"method"] = @"CCStoreEventHandler::onUnexpectedStoreError";
        parameters[@"errorCode"] = errorCode;
    }];

    [ndkGlue registerCallbackHandlerForKey:EVENT_ID_SOOMLASTORE_INIT withBlock:^(NSNotification *notification, NSMutableDictionary *parameters) {
