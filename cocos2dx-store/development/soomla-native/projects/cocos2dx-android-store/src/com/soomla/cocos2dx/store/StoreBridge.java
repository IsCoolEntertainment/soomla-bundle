...
public class StoreBridge {
    ...
    public StoreBridge() {
        ...
        ndkGlue.registerCallHandler("CCStoreEventDispatcher::pushOnPurchaseVerified", new NdkGlue.CallHandler() {
            @Override
            public void handle(JSONObject params, JSONObject retParams) throws Exception {
                final String itemType = params.getString( "itemType" );
                final String signature = params.getString( "signature" );
                final String originalJson = params.getString( "originalJson" );

                storeEventHandlerBridge.pushOnPurchaseVerified
                    ( itemType, originalJson, signature );
            }
        });
