...
namespace soomla {
    ...
    public:
        ...
        static char const *DICT_ELEMENT_ITEM_TYPE;
        static char const *DICT_ELEMENT_IS_RESTORED;
        ...
        static char const *EVENT_PURCHASE_VERIFICATION_STARTED;
        static char const *EVENT_PURCHASE_VERIFIED;
        ...
        static const int ERR_GENERAL;
        static const int ERR_VERIFICATION_TIMEOUT;
        static const int ERR_VERIFICATION_FAIL;
        static const int ERR_PURCHASE_FAIL;
