...
namespace soomla {
    ...
    char const *CCStoreConsts::DICT_ELEMENT_ITEM_TYPE = "itemType";
    char const *CCStoreConsts::DICT_ELEMENT_IS_RESTORED = "isRestored";
    ...
    char const *CCStoreConsts::EVENT_PURCHASE_VERIFICATION_STARTED = "CCStoreEventHandler::onPurchaseVerificationStarted";
    char const *CCStoreConsts::EVENT_PURCHASE_VERIFIED = "CCStoreEventHandler::onPurchaseVerified";
    ...
    const int CCStoreConsts::ERR_GENERAL = 0;
    const int CCStoreConsts::ERR_VERIFICATION_TIMEOUT = 1;
    const int CCStoreConsts::ERR_VERIFICATION_FAIL = 2;
    const int CCStoreConsts::ERR_PURCHASE_FAIL = 3;
}
