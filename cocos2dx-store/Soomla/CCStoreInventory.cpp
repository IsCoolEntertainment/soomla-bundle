...
#define TAG "SOOMLA StoreInventory"
    ...
    bool CCStoreInventory::canAfford(const char *itemId, CCError **error) {
        CCSoomlaUtils::logDebug(TAG, cocos2d::__String::createWithFormat("Checking can afford: %s", itemId)->getCString());
    ...
    void CCStoreInventory::buyItem(char const *itemId, const char *payload, CCError **error) {
        CCSoomlaUtils::logDebug(TAG, cocos2d::__String::createWithFormat("Buying: %s", itemId)->getCString());
    ...
    int CCStoreInventory::getItemBalance(char const *itemId, CCError **error) {
        cocos2d::__Integer *amount = dynamic_cast<cocos2d::__Integer *>(mLocalItemBalances->objectForKey(itemId));
        if (amount != NULL) {
    ...
    void CCStoreInventory::giveItem(char const *itemId, int amount, CCError **error) {
        CCSoomlaUtils::logDebug(TAG, cocos2d::__String::createWithFormat("Giving: %d pieces of: %s", amount, itemId)->getCString());
    ...
    void CCStoreInventory::takeItem(char const *itemId, int amount, CCError **error) {
        CCSoomlaUtils::logDebug(TAG, cocos2d::__String::createWithFormat("Taking: %d pieces of: %s", amount, itemId)->getCString());
    ...
    void CCStoreInventory::equipVirtualGood(char const *itemId, CCError **error) {
        CCSoomlaUtils::logDebug(TAG, cocos2d::__String::createWithFormat("Equipping: %s", itemId)->getCString());
    ...
    void CCStoreInventory::unEquipVirtualGood(char const *itemId, CCError **error) {
        CCSoomlaUtils::logDebug(TAG, cocos2d::__String::createWithFormat("UnEquipping: %s", itemId)->getCString());
    ...
    bool CCStoreInventory::isVirtualGoodEquipped(char const *itemId, CCError **error) {
        CCSoomlaUtils::logDebug(TAG, cocos2d::__String::createWithFormat("Checking if %s is equipped", itemId)->getCString());
    ...
    int CCStoreInventory::getGoodUpgradeLevel(char const *goodItemId, CCError **error) {
        CCSoomlaUtils::logDebug(TAG, cocos2d::__String::createWithFormat("Checking %s upgrade level", goodItemId)->getCString());
    ...
    std::string CCStoreInventory::getGoodCurrentUpgrade(char const *goodItemId, CCError **error) {
        CCSoomlaUtils::logDebug(TAG, cocos2d::__String::createWithFormat("Checking %s current upgrade", goodItemId)->getCString());
    ...
    void CCStoreInventory::upgradeGood(char const *goodItemId, CCError **error) {
        CCSoomlaUtils::logDebug(TAG, cocos2d::__String::createWithFormat("Upgrading Good with: %s", goodItemId)->getCString());
        CCVirtualGood *good = dynamic_cast<CCVirtualGood *>(CCStoreInfo::sharedStoreInfo()->getItemByItemId(goodItemId, error));
        if (good == NULL) {
            return;
        }
        ...
        if (upgradeVG != NULL) {
            cocos2d::__String *nextItemId = upgradeVG->getNextItemId();
    ...
    void CCStoreInventory::removeGoodUpgrades(char const *goodItemId, CCError **error) {
        CCSoomlaUtils::logDebug(TAG, cocos2d::__String::createWithFormat("Removing Good Upgrades for: %s", goodItemId)->getCString());
        
        cocos2d::__Array *upgrades = CCStoreInfo::sharedStoreInfo()->getUpgradesForVirtualGood(goodItemId);
        Ref *obj;
    ...
    void CCStoreInventory::refreshLocalInventory() {
        ...
        CCARRAY_FOREACH(CCStoreInfo::sharedStoreInfo()->getCurrencies(), obj) {
            ...
            CC_ASSERT(item);
            mLocalItemBalances->setObject(cocos2d::__Integer::create(CCVirtualCurrencyStorage::getInstance()->getBalance(item)), item->getItemId()->getCString());
        }
        ...
        CCARRAY_FOREACH(CCStoreInfo::sharedStoreInfo()->getGoods(), obj) {
            ...
            mLocalItemBalances->setObject(cocos2d::__Integer::create(balance), item->getItemId()->getCString());
            ...
            if (upgrade != NULL) {
                ...
                localUpgrade->setLevel(cocos2d::__Integer::create(upgradeLevel));
    ...
    void CCStoreInventory::refreshOnGoodUpgrade(CCVirtualGood *vg, CCUpgradeVG *uvg) {
        if (uvg == NULL) {
            ...
            if (upgrade != NULL) {
                ...
                upgrade->setLevel(cocos2d::__Integer::create(upgradeLevel));
            }
            else {
                CCLocalUpgrade *localUpgrade = CCLocalUpgrade::create();
    ...
    void CCStoreInventory::updateLocalBalance(const char *itemId, int balance) {
        mLocalItemBalances->setObject(cocos2d::__Integer::create(balance), itemId);
    }
