...
namespace soomla {
    ...
    CCMarketItem *CCMarketItem::create(cocos2d::__String *productId, cocos2d::__Double *price) {
    ...
    bool CCMarketItem::init(cocos2d::__String *productId, cocos2d::__Double *price) {
    ...
    bool CCMarketItem::initWithDictionary(cocos2d::__Dictionary *dict) {
        ...
        CCAssert(obj == NULL || dynamic_cast<cocos2d::__String *>(obj), "invalid object type in dictionary");
        setProductId((cocos2d::__String *)obj);
    ...
    cocos2d::__Dictionary *CCMarketItem::toDictionary() {
