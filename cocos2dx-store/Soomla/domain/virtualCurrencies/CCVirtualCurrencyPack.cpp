...
namespace soomla {
    ...
    CCVirtualCurrencyPack *CCVirtualCurrencyPack::create(cocos2d::__String *name, cocos2d::__String *description, cocos2d::__String *itemId, cocos2d::__Integer *currencyAmount, cocos2d::__String *currencyItemId, CCPurchaseType *purchaseType) {
    ...
    bool CCVirtualCurrencyPack::init(cocos2d::__String *name, cocos2d::__String *description, cocos2d::__String *itemId, cocos2d::__Integer *currencyAmount, cocos2d::__String *currencyItemId, CCPurchaseType *purchaseType) {
    ...
    bool CCVirtualCurrencyPack::initWithDictionary(cocos2d::__Dictionary *dict) {
    ...
    cocos2d::__Dictionary *CCVirtualCurrencyPack::toDictionary() {
    ...
    int CCVirtualCurrencyPack::give(int amount, bool notify, CCError **error) {
        ...
        if (currency == NULL) {
            CCSoomlaUtils::logError(TAG, cocos2d::__String::createWithFormat("VirtualCurrency with itemId: %s doesn't exist! Can't give this pack.", currencyId)->getCString());
            return 0;
        }
    ...
    int CCVirtualCurrencyPack::take(int amount, bool notify, CCError **error) {
        ...
        if (currency == NULL) {
            CCSoomlaUtils::logError(TAG, cocos2d::__String::createWithFormat("VirtualCurrency with itemId: %s doesn't exist! Can't take this pack.", currencyId)->getCString());
            return 0;
        }
