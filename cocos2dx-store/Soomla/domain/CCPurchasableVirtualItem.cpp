...
namespace soomla {
    ...
    cocos2d::__Dictionary*CCPurchasableVirtualItem::toDictionary() {
        cocos2d::__Dictionary* dict = CCVirtualItem::toDictionary();
    ...
    void CCPurchasableVirtualItem::fillPurchaseTypeFromDict(cocos2d::__Dictionary *dict) {
        cocos2d::__Dictionary *purchasableDict = dynamic_cast<cocos2d::__Dictionary *>(dict->objectForKey(CCStoreConsts::JSON_PURCHASABLE_ITEM));
        CC_ASSERT(purchasableDict);
        cocos2d::__String* purchaseTypeStr = dynamic_cast<cocos2d::__String *>(purchasableDict->objectForKey(CCStoreConsts::JSON_PURCHASE_TYPE));
        ...
        if (purchaseTypeStr->compare(CCStoreConsts::JSON_PURCHASE_TYPE_MARKET) == 0) {
            cocos2d::__Dictionary *marketItemDict = dynamic_cast<cocos2d::__Dictionary *>(purchasableDict->objectForKey(CCStoreConsts::JSON_PURCHASE_MARKET_ITEM));
            ...
            cocos2d::__String *itemId = dynamic_cast<cocos2d::__String *>(purchasableDict->objectForKey(CCStoreConsts::JSON_PURCHASE_VI_ITEM_ID));
            CC_ASSERT(itemId);
            cocos2d::__Integer *amount = dynamic_cast<cocos2d::__Integer *>(purchasableDict->objectForKey(CCStoreConsts::JSON_PURCHASE_VI_AMOUNT));
            CC_ASSERT(amount);
    ...
    void CCPurchasableVirtualItem::putPurchaseTypeToDict(cocos2d::__Dictionary *dict) {
        cocos2d::__Dictionary *purchasableObj = cocos2d::__Dictionary::create();

        if (dynamic_cast<CCPurchaseWithMarket *>(mPurchaseType)) {
            purchasableObj->setObject(cocos2d::__String::create(CCStoreConsts::JSON_PURCHASE_TYPE_MARKET), CCStoreConsts::JSON_PURCHASE_TYPE);
            ...
            purchasableObj->setObject(cocos2d::__String::create(CCStoreConsts::JSON_PURCHASE_TYPE_VI), CCStoreConsts::JSON_PURCHASE_TYPE);
