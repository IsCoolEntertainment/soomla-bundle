...
namespace soomla {
    ...
    CCVirtualItem *CCStoreInfo::getItemByItemId(char const *itemId, CCError **error) {
        CCSoomlaUtils::logDebug(TAG,
							   cocos2d::__String::createWithFormat("Trying to fetch an item with itemId: %s", itemId)->getCString());
        ...
        CCError::tryFillError(error, cocos2d::__String::createWithFormat("Virtual item was not found when searching with itemId=%s", itemId));
        return NULL;
    }

    CCPurchasableVirtualItem *CCStoreInfo::getPurchasableItemWithProductId(char const *productId, CCError **error) {
        CCSoomlaUtils::logDebug(TAG,
                                cocos2d::__String::createWithFormat("Trying to fetch a purchasable item with productId: %s", productId)->getCString());
        ...
        CCError::tryFillError(error, cocos2d::__String::createWithFormat("Virtual item was not found when searching with productId=%s", productId));
        return NULL;
    }

    CCVirtualCategory *CCStoreInfo::getCategoryForVirtualGood(char const *goodItemId, CCError **error) {
        CCSoomlaUtils::logDebug(TAG,
                                cocos2d::__String::createWithFormat("Trying to fetch a category for a good with itemId: %s", goodItemId)->getCString());
        ...
        CCError::tryFillError(error, cocos2d::__String::createWithFormat("Virtual item was not found when searching with goodItemId of category=%s", goodItemId));
        return NULL;
    }

    CCUpgradeVG *CCStoreInfo::getFirstUpgradeForVirtualGood(char const *goodItemId) {
        CCSoomlaUtils::logDebug(TAG,
                                cocos2d::__String::createWithFormat("Trying to fetch first upgrade of a good with itemId: %s", goodItemId)->getCString());
        
        cocos2d::__Array *upgrades = dynamic_cast<cocos2d::__Array *>(getGoodsUpgrades()->objectForKey(goodItemId));
        if (upgrades != NULL) {
            Ref *obj;
    ...
    CCUpgradeVG *CCStoreInfo::getLastUpgradeForVirtualGood(char const *goodItemId) {
        CCSoomlaUtils::logDebug(TAG,
                                cocos2d::__String::createWithFormat("Trying to fetch last upgrade of a good with itemId: %s", goodItemId)->getCString());
    ...
    cocos2d::__Array *CCStoreInfo::getUpgradesForVirtualGood(char const *goodItemId) {
        CCSoomlaUtils::logDebug(TAG,
                                cocos2d::__String::createWithFormat("Trying to fetch upgrades of a good with itemId: %s", goodItemId)->getCString());
    ...
    void CCStoreInfo::save() {
        cocos2d::__Dictionary *storeDict = toDictionary();
        const char *jsonString = json_dumps(CCJsonHelper::getJsonFromCCObject(storeDict), JSON_COMPACT | JSON_ENSURE_ASCII);
        CCSoomlaUtils::logDebug(TAG, cocos2d::__String::createWithFormat("saving StoreInfo to DB. json is: %s", jsonString)->getCString());
        CCKeyValueStorage::getInstance()->setValue(KEY_META_STORE_INFO, jsonString);
    }

    cocos2d::__Dictionary *CCStoreInfo::storeAssetsToDictionary(CCStoreAssets *storeAssets) {
        cocos2d::__Array *currenciesJSON = cocos2d::__Array::create();
        {
            cocos2d::__Array *currencies = storeAssets->getCurrencies();
            Ref *obj;
        ...
        cocos2d::__Array *packsJSON = cocos2d::__Array::create();
        {
            cocos2d::__Array *packs = storeAssets->getCurrencyPacks();
            Ref *obj;
        ...
        cocos2d::__Array *suGoods = cocos2d::__Array::create();
        cocos2d::__Array *ltGoods = cocos2d::__Array::create();
        cocos2d::__Array *eqGoods = cocos2d::__Array::create();
        cocos2d::__Array *upGoods = cocos2d::__Array::create();
        cocos2d::__Array *paGoods = cocos2d::__Array::create();
        ...
        cocos2d::__Dictionary *goodsJSON = cocos2d::__Dictionary::create();
        ...
        cocos2d::__Array *categoriesJSON = cocos2d::__Array::create();
        {
            cocos2d::__Array *categories = storeAssets->getCategories();
            Ref *obj;
        ...
        cocos2d::__Dictionary *storeAssetsObj = cocos2d::__Dictionary::create();
    ...
    void CCStoreInfo::setStoreAssets(CCStoreAssets *storeAssets) {
        cocos2d::__Dictionary *storeDict = storeAssetsToDictionary(storeAssets);
        const char *jsonString = json_dumps(CCJsonHelper::getJsonFromCCObject(storeDict), JSON_COMPACT | JSON_ENSURE_ASCII);
        CCKeyValueStorage::getInstance()->setValue(KEY_META_STORE_INFO, jsonString);
    }
    ...
    void CCStoreInfo::initializeFromDB() {
        ...
        CCSoomlaUtils::logDebug(TAG, cocos2d::__String::createWithFormat("the metadata-economy json (from DB) is %s", val)->getCString());
        ...
        cocos2d::__Dictionary *storeDict = dynamic_cast<cocos2d::__Dictionary *>(CCJsonHelper::getCCObjectFromJson(storeJson));
    ...
    void CCStoreInfo::updateAggregatedLists() {
        ...
        CCARRAY_FOREACH(getGoods(), obj) {
            ...
            if (upgradeVG != NULL) {
                cocos2d::__Array *upgrades = dynamic_cast<cocos2d::__Array *>(getGoodsUpgrades()->objectForKey(upgradeVG->getGoodItemId()->getCString()));
                if (upgrades == NULL) {
                    upgrades = cocos2d::__Array::create();
        ...
        CCARRAY_FOREACH(getCategories(), obj) {
            ...
            CCARRAY_FOREACH(category->getGoodItemIds(), itemIdObj) {
                cocos2d::__String *goodItemId = dynamic_cast<cocos2d::__String *>(itemIdObj);
    ...
    bool CCStoreInfo::initWithDictionary(cocos2d::__Dictionary* dict) {
        ...
        setVirtualItems(cocos2d::__Dictionary::create());
        setPurchasableItems(cocos2d::__Dictionary::create());
        setGoodsCategories(cocos2d::__Dictionary::create());
        setGoodsUpgrades(cocos2d::__Dictionary::create());
        
        Ref *ref;
        
        ref = dict->objectForKey(CCStoreConsts::JSON_STORE_CURRENCIES);
        if (ref) {
            cocos2d::__Array *currenciesDictArray = dynamic_cast<cocos2d::__Array *>(ref);
            CC_ASSERT(currenciesDictArray);
            cocos2d::__Array *currenciesArray = CCDomainHelper::getInstance()->getDomainsFromDictArray(currenciesDictArray);
            setCurrencies(currenciesArray);
        }
        
        ref = dict->objectForKey(CCStoreConsts::JSON_STORE_CURRENCY_PACKS);
        if (ref) {
            cocos2d::__Array *currencyPacksDictArray = dynamic_cast<cocos2d::__Array *>(ref);
            CC_ASSERT(currencyPacksDictArray);
            cocos2d::__Array *currencyPacksArray = CCDomainHelper::getInstance()->getDomainsFromDictArray(currencyPacksDictArray);
            setCurrencyPacks(currencyPacksArray);
        }
        
        setGoods(cocos2d::__Array::create());
        ref = dict->objectForKey(CCStoreConsts::JSON_STORE_GOODS);
        if (ref) {
            cocos2d::__Dictionary *goodsDictArray = dynamic_cast<cocos2d::__Dictionary *>(ref);
            CC_ASSERT(goodsDictArray);
            
            ref = goodsDictArray->objectForKey(CCStoreConsts::JSON_STORE_GOODS_SU);
            if (ref) {
                cocos2d::__Array *singleUseDictArray = dynamic_cast<cocos2d::__Array *>(ref);
                CC_ASSERT(singleUseDictArray);
                
                cocos2d::__Array *suGoods = CCDomainHelper::getInstance()->getDomainsFromDictArray(singleUseDictArray);
                Ref *obj;
            ...
            if (ref) {
                cocos2d::__Array *liftimeDictArray = dynamic_cast<cocos2d::__Array *>(ref);
                CC_ASSERT(liftimeDictArray);
                
                cocos2d::__Array *ltGoods = CCDomainHelper::getInstance()->getDomainsFromDictArray(liftimeDictArray);
                Ref *obj;
            ...
            if (ref) {
                cocos2d::__Array *equippableDictArray = dynamic_cast<cocos2d::__Array *>(ref);
                CC_ASSERT(equippableDictArray);
                
                cocos2d::__Array *eqGoods = CCDomainHelper::getInstance()->getDomainsFromDictArray(equippableDictArray);
                Ref *obj;
            ...
            if (ref) {
                cocos2d::__Array *singleUsePackDictArray = dynamic_cast<cocos2d::__Array *>(ref);
                CC_ASSERT(singleUsePackDictArray);
                
                cocos2d::__Array *paGoods = CCDomainHelper::getInstance()->getDomainsFromDictArray(singleUsePackDictArray);
                Ref *obj;
            ...
            if (ref) {
                cocos2d::__Array *upgradeDictArray = dynamic_cast<cocos2d::__Array *>(ref);
                CC_ASSERT(upgradeDictArray);
                
                cocos2d::__Array *upGoods = CCDomainHelper::getInstance()->getDomainsFromDictArray(upgradeDictArray);
                Ref *obj;
        ...
        if (ref) {
            cocos2d::__Array *categoriesDictArray = dynamic_cast<cocos2d::__Array *>(ref);
            CC_ASSERT(categoriesDictArray);
            cocos2d::__Array *categoriesArray = CCDomainHelper::getInstance()->getDomainsFromDictArray(categoriesDictArray);
    ...
    cocos2d::__Dictionary* CCStoreInfo::toDictionary() {
        
        cocos2d::__Array *currenciesJSON = cocos2d::__Array::create();
        {
            cocos2d::__Array *currencies = getCurrencies();
            Ref *obj;
            CCARRAY_FOREACH(currencies, obj) {
                currenciesJSON->addObject(((CCVirtualCurrency *)obj)->toDictionary());
            }
        ...
        cocos2d::__Array *packsJSON = cocos2d::__Array::create();
        {
            cocos2d::__Array *packs = getCurrencyPacks();
            Ref *obj;
            CCARRAY_FOREACH(packs, obj) {
                packsJSON->addObject(((CCVirtualCurrencyPack *)obj)->toDictionary());
            }
        ...
        cocos2d::__Array *categoriesJSON = cocos2d::__Array::create();
        {
            cocos2d::__Array *categories = getCategories();
            Ref *obj;
            CCARRAY_FOREACH(categories, obj) {
                categoriesJSON->addObject(((CCVirtualCategory *)obj)->toDictionary());
            }
