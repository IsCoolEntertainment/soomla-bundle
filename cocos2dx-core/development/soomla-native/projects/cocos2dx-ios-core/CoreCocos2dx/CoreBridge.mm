...
+ (void)initGlue {
    ...
    /* -= Callback handlers =- */
    [ndkGlue registerCallbackHandlerForKey:EVENT_ID_REWARD_GIVEN withBlock:^(NSNotification *notification, NSMutableDictionary *parameters) {
        parameters[@"method"] = @"com.soomla.events.RewardGivenEvent";
        NSString *rewardId = (notification.userInfo)[DICT_ELEMENT_ID_REWARD];
        parameters[@"reward"] = rewardId;
    }];
    [ndkGlue registerCallbackHandlerForKey:EVENT_ID_REWARD_TAKEN withBlock:^(NSNotification *notification, NSMutableDictionary *parameters) {
        parameters[@"method"] = @"com.soomla.events.RewardTakenEvent";
        NSString *rewardId = (notification.userInfo)[DICT_ELEMENT_ID_REWARD];
        parameters[@"reward"] = rewardId;
    }];
    [ndkGlue registerCallbackHandlerForKey:EVENT_ID_CUSTOM withBlock:^(NSNotification *notification, NSMutableDictionary *parameters) {
        parameters[@"method"] = @"com.soomla.events.CustomEvent";
        NSDictionary* userInfo = [notification userInfo];
        NSString *name = [userInfo objectForKey:DICT_ELEMENT_ID_NAME];
        NSDictionary* extraDict = [userInfo objectForKey:DICT_ELEMENT_ID_EXTRA];
        if (extraDict) {
